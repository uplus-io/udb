...
func NewLocalDataOperations(engine *Engine, dataComm proto.ClusterDataCommunication, receiver int32) *LocalDataOperations {
	return &LocalDataOperations{engine: engine, dataComm: dataComm, queue: make([]*proto.DataBody, 0), receiver: receiver}
}
...
func (p *LocalDataOperations) put(partition proto.Partition, meta proto.DataMeta, data proto.DataContent, err error) {
...
func (p *LocalDataOperations) Push(dataArray []*proto.DataBody) {
...
// A更新自己的本地数据
func (p *LocalDataOperations) Pull([]*proto.DataBody) {

}

func (p *LocalDataOperations) MatchPartition(partId, partIndex, ring int32) *proto.Partition {
